 ...
 * Path Forward. Un nodo che dovrà scoprire un path a lunghezza maggiore non può essere gestito in questa versione
 ...
 * Si consiglia di mantenere un valore basso per le trasmissioni in upstream, dove si può sfruttare lo switching
 * dinamico del path di upstream, mentre le ritrasmissioni in upstream dovrebbe essere più elevato perchè un pacchetto
 * perso verrà ritrasmesso soltanto quando i meccanismi di ritrasmissione di alto livello si attiveranno
 */
 ...
 * downstream table cade esso non viene eliminato ma semplicemente penalizzato. qui si può configurare
